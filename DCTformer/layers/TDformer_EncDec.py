...
class Encoder(nn.Module):
    def __init__(self, attn_layers, conv_layers=None, norm_layer=None, conv_layer=None):
...
class Decoder(nn.Module):
    def __init__(self, layers, norm_layer=None, projection=None, conv_layer=None):
